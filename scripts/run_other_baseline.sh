...
#python fs_mol/baseline_numeric_test_knn.py  "/home/fengbin/datas/PQSAR/PQSAR_FEAT" \
#      --task-list-file /home/fengbin/datas/PQSAR/pqsar_split.json  --train-sizes "[16]" --num-runs 1 --save-dir "${RP}/result_indomain/pqsar/KNN"
#python fs_mol/baseline_numeric_test.py  "/home/fengbin/datas/PQSAR/PQSAR_FEAT" \
#      --task-list-file /home/fengbin/datas/PQSAR/pqsar_split.json  --train-sizes "[16]" --num-runs 1 --save-dir "${RP}/result_indomain/pqsar/RF"
#python fs_mol/gpst_test.py  "/home/fengbin/datas/PQSAR/PQSAR_FEAT" --use-numeric-labels \
#      --task-list-file /home/fengbin/datas/PQSAR/pqsar_split.json  --train-sizes "[16]" --num-runs 1 --save-dir "${RP}/result_indomain/pqsar/GPST"

CNP_PQSAR_CKPT="/mnt/sfs_turbo/fengbin/ADKF-IFT/outputs/FSMol_CNPModel_ecfp+fc_2023-10-06_15-26-50"
DKT_PQSAR_CKPT="/mnt/sfs_turbo/fengbin/ADKF-IFT/outputs/FSMol_DKTModel_ecfp+fc_2023-10-06_15-27-01"
#python fs_mol/cnp_train.py "/home/fengbin/datas/PQSAR/PQSAR_FEAT" --batch_size 2048 \
#      --task-list-file /home/fengbin/datas/PQSAR/pqsar_split.json  --use-numeric-labels  --num_train_steps 80000 --validate_every 4000
#python fs_mol/dkt_train.py "/home/fengbin/datas/PQSAR/PQSAR_FEAT" --batch_size 2048 \
#      --task-list-file /home/fengbin/datas/PQSAR/pqsar_split.json  --use-numeric-labels  --num_train_steps 80000 --validate_every 4000

python fs_mol/cnp_test.py  "${CNP_PQSAR_CKPT}/best_validation.pt" "/home/fengbin/datas/PQSAR/PQSAR_FEAT" \
      --task-list-file /home/fengbin/datas/PQSAR/pqsar_split.json  --batch-size 2048 --train-sizes "[16]" --num-runs 1 --save-dir "${RP}/result_indomain/pqsar/CNP"
python fs_mol/dkt_test.py  "${DKT_PQSAR_CKPT}/best_validation.pt" "/home/fengbin/datas/PQSAR/PQSAR_FEAT" \
      --task-list-file /home/fengbin/datas/PQSAR/pqsar_split.json  --batch-size 2048 --train-sizes "[16]" --num-runs 1 --save-dir "${RP}/result_indomain/pqsar/DKT"